...
// WithDefaults hydrates default values in the get entry params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEntryParams) WithDefaults() *GetEntryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get entry params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEntryParams) SetDefaults() {
...
// WithPodName adds the podName to the get entry params
func (o *GetEntryParams) WithPodName(podName string) *GetEntryParams {
	o.SetPodName(podName)
	return o
}

// SetPodName adds the podName to the get entry params
func (o *GetEntryParams) SetPodName(podName string) {
	o.PodName = podName
}
